...
import { HeartIconSmall, CalendarIconSmall, IdCardIconSmall, AppleIcon, AndroidIcon} from './../../icons/index';
    ...
    <Layout style={{backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center'}} className='wrapper'>
        ...
        <Layout style={{backgroundColor: 'transparent'}} className='site_layout'>
            ...
            <Content className='main'>
                <div className='block_skills'>C CleverFit ты сможешь: <br/>— планировать свои тренировки на календаре, выбирая тип и уровень нагрузки;<br/> — отслеживать свои достижения в разделе статистики, сравнивая свои результаты c нормами и рекордами; <br/>— создавать свой профиль, где ты можешь загружать свои фото, видео и отзывы o тренировках; <br/>— выполнять расписанные тренировки для разных частей тела, следуя подробным инструкциям и советам профессиональных тренеров.</div>
                <div className='sub_title'>CleverFit — это не просто приложение, a твой личный помощник в мире фитнеса. He откладывай на завтра — начни тренироваться уже сегодня!</div>
                <div className='block_cards'>
                    <div className='cards_wrapper'>
                    <Card title='Расписать тренировки' link='Тренировки' icon={<HeartIconSmall/>}/>
                    <Card title='Назначить календарь' link='Календарь' icon={<CalendarIconSmall/>}/>
                    <Card title='Заполнить профиль' link='Профиль' icon={<IdCardIconSmall />}/>
                    </div>
                </div>
